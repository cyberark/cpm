...
function Get-ScrambledString {
    ...
    # Convert string to char array and shuffle
    $shuffledArray = $InputString.ToCharArray() | Sort-Object {Get-Random}
    # Join characters back into a single string
    -join $shuffledArray
}

try {
  WriteLog -LogFile $LogFile -LogLevel "INFO" -Log "Set new password"
  $randomPassword = Get-RandomCharacters -length 5 -characters 'abcdefghiklmnoprstuvwxyz'
  $randomPassword += Get-RandomCharacters -length 5 -characters 'ABCDEFGHKLMNOPRSTUVWXYZ'
  $randomPassword += Get-RandomCharacters -length 5 -characters '1234567890'
  $password_prefix = Get-RandomCharacters -length 1 -characters 'abcdefghiklmnoprstuvwxyzABCDEFGHKLMNOPRSTUVWXYZ'
  $Password = $password_prefix + (Get-ScrambledString($randomPassword))
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC6rycZQymipcyz
# S6UM7/S2aggOUckReoTInRVcRuP6DaCCDpUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# BDEiBCD1Es8qB+paUq/NCEMObhr8n6ELMuG8RaRNhF3fgmVNrDANBgkqhkiG9w0B
# AQEFAASCAgAnPLIUE2Dlt8N5JpHgAcDti+eMyoVJnZgUvzr6SaDETrZtfKTnrDj2
# miNYwx/m91v+sF1UMy3FpOomTPVWu+fj07lF9qvu6dFKJByhDBJ0hBrY5qVJRfom
# iTa3YgD7vTNFYcSLHJgO9kJKtcH30WojWwyPw5JrzkxFuBlwkBMCJUDOs+tN8YI/
# Z0pgWxrGxUkwAYbs6ZQ9jzHTkfwa3QFtOuQmw9MkOqupiD9h2BLkahYVjH/aORf5
# 4dHmey5wT3GwzPkisPrS3s+HStnDYSRImk+Mn67aVb05kOW66Tclsm9T5RZ8GPok
# M6caad+HjGMMWxvLQ3hDVs7I+prVuBkgNGYwI3q8M45HibOqWQJaHlmXsZHFrSv/
# dp8uHFG141Zic2iFtfgSG7DdBpOTxSOlnvKbsHrmD5TrKPcl3ixnXapHyfTdePXv
# oUqeAGG3YNEZOTSn9OiGE0Th3i4jyocP+gR3/jDj423G7nwJrusLccZePutuAfLV
# D6ZxlO2ndmSs8q8++LG3/T+enjTEHDFnYrV1HnNlFjhFRj5Bxd3WIm5N+K9wG6ak
# NGXFbB4TObETJxy1nOUH/Wc9k7p8MpnsQxznGQOm+Nighg4PrUeEgHzfGGRybuc9
# Te5TG8JHKAhSUxOAbcODfm0gIBJb+VU8e257BGOle7njg9NRbaVLG6GCFs0wghbJ
...
# AQIwMTANBglghkgBZQMEAgEFAAQgV8T1h9KUemS/T/9inYg0OxSRKUz1IcsZE4NR
# l+UWm7ICFGzIJkKyNIBV5OvsP71mAIsw04xMGA8yMDI0MTIwNTEwMjUyOVowAwIB
...
# BAIBoQ0GCSqGSIb3DQEBCwUAMC8GCSqGSIb3DQEJBDEiBCDrKmyD6/d3j7b4lGbq
# bg6iz3u5/ahxBllVY4roKzd3LjCBsAYLKoZIhvcNAQkQAi8xgaAwgZ0wgZowgZcE
...
# Op8uASQWMA0GCSqGSIb3DQEBCwUABIIBgIPeZUwuXvaN+k0OAy6bqEW+UZOwQW8p
# 0ufQrC1e3WL2hfcJczazuqmonGHmlJVMLO9bH6UqBX1lH7G92O8S6G24FTPXgb0x
# pdj7WifrHgZpOVnYWOnJKjdvJ+6j54qyFLLg/n5BNIkDulIERvCLfMGturN7LU5o
# lQj5JsMJBAMYu9bcGb8t7RuKSIwZR5+XpU+TJ/12GfHmH+qFbBuQeQ4URamc2Sh5
# 6n+N1Nz01p2raMSWAFiQ/LHerUUsHX7yLkvqUVoOy5xEXayCHnZ92RQ5QZWQnYZe
# ie+uxYyaJskYfuGS/JyWkeSczvhYwSNvRpMOZ9MDNHATTWz2UnAeTDUsh6reDWqm
# qINGhLO2SuWSOon7NMJCoA8QHRnzwyW4qdNLSG7VrG+oQ5dK0t1DRsqn+Sr7qh6R
# wBkvswFLixeOZJfKLxxl9lkoVfGbasPLtVczYulK1eAzqvF06GWG6a2HKqc7u71a
# SluhHRlz/jcGvEGk8PSCWGh00VmNTwKPWQ==
