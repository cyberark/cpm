...
Param(
    ...
    [Parameter(Mandatory=$true)][string]$CPMCfnInitLogStream,
    [Parameter(Mandatory=$true)][string]$CPMConfiguration,
    [Parameter(Mandatory=$true)][string]$CPMSetLocalService,
    [Parameter(Mandatory=$true)][string]$CPMRegistration
)
...
((Get-Content -Path "C:\Program Files\Amazon\SSM\Plugins\awsCloudWatch\AWS.EC2.Windows.CloudWatch.json" -Raw)`
         ...
         -Replace 'CPM_CFN_LOG_PH',$CPMCfnInitLogStream `
         -Replace 'CPM_CONF_LOG_PH',$CPMConfiguration `
         -Replace 'CPM_LOCALSERVICE_LOG_PH',$CPMSetLocalService `
         -Replace 'CPMREGISTRATION_LOG_PH',$CPMRegistration)| Out-File `
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBZdHcTVVWKE8ve
# ECSJzepFoNybrGHemBc5waJV7jRVPqCCDl8wggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# mPnYtXAigNQVikCVjU9Hatd1nbgq/pG4aMddPIbRujANBgkqhkiG9w0BAQEFAASC
# AgC0VulpTnHhAwT+rQ6YIAd01uuoNErWDTYOlfjiB53yXCuqAwQ+pSCT6foI1/cs
# VvG6BM64sUZLZVLvTWB0jLMcabuLlY7Lqvn31Y6yUT7GLvBX4x374JWPuOvnSFco
# KFdgkA0KZq4I3YzwvPNShgISDe+I6A7eU9EFikPZ0mIFoBtFZqAi4yGxA6GNDSsb
# XscLY5pgc5TH1q8k3Q3Xmwxd+zf1Z1nwaGu2l7V+XraPe8Gd360Nkqt2ueqZiTlo
# 2/l20IhbqLzhaA6JOcCv4p7T1PD3JsfZj7f1G5iK27sJagu82QlbKLZI2MPhgwbR
# 0vCu0MzEPLg5KtJpeIzltofnd4BxQm5MlEMrTkZtSv8DEkkk/MroTZ5zob7jKQJC
# wH6Uycj0TCstDZl0aCSywTVxAhfEEq6gk2xIUHVXvhqXOGSSJL9nsroFyNEDStA2
# 550v3ciCf5v15Ip2Q5dOTFeWsER6j+PSkpBiq+rvd7btd/zlX+liwHisOnIop8va
# kSMdkt27z8AyJqD+V61w55XM/V1Czqz0IjVZEXCMOpq18oQGHXn+Ty06/OriRUGn
# d8nEicp8j2W+q/2EnnN+oDpXXGzLmCyh9w6qbUml7dBEECvHlEf/deAfteWlJ7DG
# byVh84nzPEj82B1TQPJrlJpag68ZPnVTaZAE133u8Ab4raGCDiswgg4nBgorBgEE
...
# BgUrDgMCGgUABBT5NeqMId8tNn1BTaGc+5dW9nNIzQIULmjnD0zL/CKpQzeXM/kI
# RX8RfWgYDzIwMjIwNDEzMTAzOTE2WjADAgEeoIGGpIGDMIGAMQswCQYDVQQGEwJV
...
# 9w0BCQUxDxcNMjIwNDEzMTAzOTE2WjAvBgkqhkiG9w0BCQQxIgQgXytTIKnc2w8b
# pNHjODImDlxmGrHopNjO7dwB7iJWHncwNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQg
# xHTOdgB9AjlODaXk3nwUxoD54oIBPP72U+9dtx/fYfgwCwYJKoZIhvcNAQEBBIIB
# ACA4//Dp14QsIE+uzqnbAlJVcukc+eE3dlIePUnbwsnWSjGTdqvfTvmgPamQUu9M
# kzuEPBiElRkxOMMaWHlT0AYKtXorRPfFPCHhSCD8GTqvXK/uA8MqKYd6/cDdXhHG
# 03JHEzv3XmWjYiM3kFxN4+l8qxApK4bu3iJVANyXaBzfzN7L8Ekv7kGWvxOgPRPF
# 6K9KzoRb9hjkYmramjJ6TU/DC+iPyQYUfQuBxi7Ap68z7bN4zrYmgrs71IJUPWsV
# idbCfZI/9qch2QTA4WosoKV4wTVGki6EOFLs5d38GJiWKDHmIi4WoDNiB02uF+cH
# tZdY3hY/DAcRpm8EVLhCYnE=
